    ...
    <main className="od-page od-space-page">
      ...
      {canManage && editPanelOpen && (
        <section className="od-edit-panel" aria-label="Modifier l'annonce">
          <div>
            <span className="od-kicker">Edition</span>
            <h2>Modifier l'annonce</h2>
            <p>Enrichissez la fiche, ajoutez les documents utiles et gardez le suivi vendeur au même endroit.</p>
          </div>
          <div>
            <button type="button" onClick={() => openManagementAction('edit-property')}>Modifier les informations</button>
            ...
            <button type="button" onClick={() => openManagementAction('seller-access')}>Créer espace vendeur</button>
          </div>
        </section>
      )}
