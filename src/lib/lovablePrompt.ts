...
const singleLovableOutputContract = [
  ...
  'Les URLs dans VisualPack.imageRoles, homeImages, sectionImages et publicPage.imageRoles doivent etre publiques et commencer par http:// ou https://.',
  'Ne jamais fournir de chemin interne ou local comme src/assets/..., /src/assets/..., localhost, file:// ou une URL relative.',
  'Si aucune URL publique n est disponible pour un role, laisser ce role absent et signaler la limite dans unsupportedCapabilities.',
