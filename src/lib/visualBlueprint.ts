...
export function getVisualBlueprintCapabilityValues() {
  return {
    sections: [...visualBlueprintSections],
    visualVariants: [...visualVariantValues],
    layout: [...layoutValues],
    heroLayout: [...heroLayoutValues],
    heroSurface: [...heroSurfaceValues],
    heroHeight: [...heroHeightValues],
    heroHeadlineScale: [...heroHeadlineScaleValues],
    alignment: [...alignmentValues],
    position: [...positionValues],
    spacing: [...spacingValues],
    imageTreatment: [...imageTreatmentValues],
    cardStyle: [...cardStyleValues],
    propertyCardVariant: [...propertyCardVariantValues],
    propertyCardOrientation: [...propertyCardOrientationValues],
    propertyCardImageRatio: [...propertyCardImageRatioValues],
    propertyCardDensity: [...propertyCardDensityValues],
    propertyCardPricePosition: [...propertyCardPricePositionValues],
    propertyCardVisibility: [...propertyCardVisibilityValues],
    propertyCardRadius: [...propertyCardRadiusValues],
    propertyCardBorder: [...propertyCardBorderValues],
    propertyCardShadow: [...propertyCardShadowValues],
    propertyCardHover: [...propertyCardHoverValues],
    buttonShape: [...buttonShapeValues],
    buttonSize: [...buttonSizeValues],
    mobileNavigation: [...mobileNavigationValues],
    themePreset: [...themePresetValues],
    compositionPreset: [...compositionPresetValues],
    navigationSurface: [...navigationSurfaceValues],
    navigationDensity: [...navigationDensityValues],
    navigationBehavior: [...navigationBehaviorValues],
    navigationLogoMode: [...navigationLogoModeValues],
    navigationVisibility: [...navigationVisibilityValues],
    proofVariant: [...proofVariantValues],
    buttonVariant: [...buttonVariantValues],
    buttonHover: [...buttonHoverValues],
    formVariant: [...formVariantValues],
    formLayout: [...formLayoutValues],
    formFieldStyle: [...formFieldStyleValues],
    dashboardStyle: [...dashboardStyleValues],
    dashboardDensity: [...dashboardDensityValues],
    dashboardNavigation: [...dashboardNavigationValues],
    dashboardCards: [...dashboardCardValues],
    motionLevel: [...motionLevelValues],
  }
}
